...
public class ManagerLeaf implements Employee {
     ...
     *
     * Because operations were defined in the component interface
     * (Employee.java), some methods will be empty in the leaf classes since
     * they aren't applicable to the leaf.
     */
    @Override
