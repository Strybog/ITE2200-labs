...
public class Director implements Employee {
    ...
    /**
     * Loops through child elements in the list for specific implementation to
     * show employee details
     *
     * Shows that the function delegates actual work to child class (in this
     * case it can be the DeveloperLeaf or ManagerLeaf).
     */
    @Override
